...
<html lang="en">
  <head>
    ...
    <script src="stanag-app6.js"></script>
  ...
  <body onload="generatenavigation();">
    ...
    <table>
      ...
      <tr>
        <td style="text-align:center;">
          <script>
            document.write(
              new ms.Symbol("SFGPEWHLS---", { size: 40, fill: false }).asSVG()
            );
          </script>
        </td>
        <td style="text-align:left;">
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.SPC // Space
        )
      );
    </script>
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.AIRTRK // Air
        )
      );
    </script>
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.GRDTRK_UNT // Ground
        )
      );
    </script>
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.GRDTRK_EQT // Ground
        )
      );
    </script>
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.GRDTRK_INS // Ground
        )
      );
    </script>
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.SSUF // Sea surface
        )
      );
    </script>
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.SBSUF // Sea subsurface
        )
      );
    </script>
    ...
    <script>
      document.write(
        renderSymbolSet(
          stanagapp6["app6b"].WAR.SOFUNT // SOF
        )
      );
    </script>

    <script>
      document.write(renderSymbolSet(stanagapp6["app6b"].TACGRP));
    </script>
  </body>
</html>
